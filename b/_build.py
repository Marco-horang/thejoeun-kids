...
<section class="band-white" id="why">
  <div class="wrap problem-grid">
    ...
    <div class="infog" aria-label="아이 한 명이 1년간 삼키게 되는 세제의 양 인포그래픽">
      ...
      <p class="cap">아이 한 명이 1년 동안 삼키게 되는 세제의 양, 소주잔 2컵 (50ml 기준)</p>
...
<section class="band-sky" id="report">
  <div class="wrap report-grid">
    ...
    <div>
      ...
      <p class="lead mt-16">정기 위생검사 결과를 원에 그대로 전달합니다. 학부모 문의에 결과지로 답하실 수 있습니다.</p>
...
<section class="band-white" id="branch">
  <div class="wrap">
    ...
    <div class="area-grid">
      <div class="area"><b>광명 본사</b><p>{ADDR}</p></div>
      <div class="area"><b>화성 공장</b><p>경기도 화성시 반월길 48-16, 1층</p></div>
